...
data.npcData = {
    ...
    classes: ["Envoy", "Mechanic", "Mystic", "Operative", "Solarian", "Soldier", "Technomancer", "Elementian"],
    types: ["Abberation", "Animal", "Construct", "Dragon", "Fey", "Humanoid", "Magical Beast", "Monstrous Humanoid", "Ooze", "Outsider", "Plant", "Undead", "Vermin"],
    grafts: ["--Elemental--", "Air", "Earth", "Fire", "Ice", "Lightning", "Magma", "Water", "--Environmental--", "Airborne", "Aquatic", "Arboreal", "Arctic", "Desert", "Forest", "Marsh", "Mountain", "Plains", "Radioactive", "Solar", "Space", "Subterranean", "Thermic", "--Template--", "Aerial (CR 1+)", "Aqueous (CR 1+)", "Astral", "Celestial", "Cthonic (CR 1+)", "Cybernetic (CR 1/2+)", "Entropic", "Fiendish", "Fiery (CR 1+)", "Giant (CR 1+)", "Miniature", "Phrenic", "Resolute", "Synthetic", "Two-Headed (CR 3+)", "Umbral", "--Occult--", "Obscured", "Nightmare", "Transposed"],
    subtypes: ["Aeon", "Aquatic", "Azata", "Brenneri", "Cold", "Damai", "Demon", "Dessamar", "Devil", "Dirindi", "Earth", "Elemental", "Espraksa", "Extraplanar", "Fire", "Giant", "Goblinoid", "Incorporeal", "Kami", "Khizar", "Oni", "Orc", "Pahtra", "Phentomite", "Plantlike", "Pyric Revenant", "Pyric Wraith", "Shakalta", "Shapechanger", "Shatori", "Shimreen", "Skittermander", "Spectra", "Strix", "Swarm", "Velstrac", "Vlaka", "Water", "---", "Anunnaki", "Deoxyomorphic", "Great Old One", "Kitsune", "Kumiho", "Levialogos", "Soulless", "Soulshell", "Uramae"],
    sizes: ["Ultrafine", "Fine", "Dimunitive", "Tiny", "Small", "Medium", "Large", "Huge", "Gargantuan", "Colossal", "Supercolossal"],
...
function updateClassData() {
    if (app.npcData.npcClass == "Envoy") {
       ...
       /* app.npcData.information = "<bold>Skills</bold>: Master Sense Motive and master Bluff, Diplomacy," +
            "or Intimidate.<br>" +
            "<bold>Ability Score Modifiers:</bold> Charisma, Intelligence, and Dexterity.<br>" +
            "Gear: Light armor (item level = CR), small arm (item level = " +
            "CR), and basic melee weapon (item level = CR – 1).";*/
    }
